...
const MODELS = [
  ...
  // ── Lovable AI Gateway — GPT-5 family ──
  ...
  // ── Trinity — OpenRouter free tier ──
  { id: "deepseek-v3", label: "DeepSeek V3 (OR)" },
  { id: "qwen-3", label: "Qwen 3 (OR)" },
  { id: "llama", label: "Llama 3.3 (OR)" },
  { id: "gemma-3", label: "Gemma 3 (OR)" },
  { id: "mistral", label: "Mistral (OR)" },
  { id: "deepseek-coder", label: "DeepSeek Coder (OR)" },
  { id: "qwen-coder", label: "Qwen Coder (OR)" },
  // ── Trinity — NVIDIA NIM ──
  { id: "nvidia-nemotron-70b", label: "Nemotron 70B (NV)" },
  { id: "nvidia-nemotron-ultra", label: "Nemotron Ultra (NV)" },
  { id: "nvidia-nemotron-super", label: "Nemotron Super (NV)" },
  { id: "nvidia-deepseek-r1", label: "DeepSeek R1 (NV)" },
  { id: "nvidia-qwen3-coder", label: "Qwen3 Coder 480B (NV)" },
  { id: "nvidia-llama4-maverick", label: "Llama 4 Maverick (NV)" },
  { id: "nvidia-llama4-scout", label: "Llama 4 Scout (NV)" },
  { id: "nvidia-mistral-small", label: "Mistral Small 3 (NV)" },
  { id: "nvidia-gemma3-27b", label: "Gemma 3 27B (NV)" },
  // ── Trinity — Premium via OpenRouter ──
  { id: "gpt", label: "GPT-4o (OR premium)" },
  { id: "claude", label: "Claude 3.5 Sonnet (premium)" },
  { id: "gemini", label: "Gemini 2.5 Pro (OR premium)" },
] as const;
